...
<p align="center">
  <img alt="версия" src="https://img.shields.io/badge/агент-0.3.19-2ea043">
...
и **Huasifey WR3000H Pro** ещё и физической кнопкой на корпусе.
...
| Модель | Примечание |
|---|---|
| ✅ **Cudy TR3000** | Есть переключение «VPN по кнопке» физической кнопкой на корпусе |
| ✅ **Huasifey WR3000H Pro** | Есть переключение «VPN по кнопке» физической кнопкой на корпусе |
| ✅ **Xiaomi AX3000T** | |
| ✅ **Netis NX31** | |
